...
https://github.com/user-attachments/assets/71389126-aa16-4405-be0d-9efaef5b721c
...
If you don't want to scroller and just want to use dwindle, then you would need to change this in the `hyprland.conf`
...
yay -S mpc-git mpd mpvpaper fastfetch starship wtype yazi waybar rofi-wayland mako
...
# Dynamic Cursor - if you wanna make your cursor quirky (please use this, its awesome)
...
- Wayland Bongo Cat: [saatvik](https://github.com/saatvik333/wayland-bongocat)
- Original waybar Theme: [mxkrsv](https://github.com/Alexays/Waybar/wiki/Examples#mxkrsvs-configuration)
- Original rofi Theme: [newmanls](https://github.com/newmanls/rofi-themes-collection)
